...
const sketch = () => {
    return ({ context, width, height, frame }) => {
        ...
        for (let i = 0; i < numCells; i++) {
            ...
            // คืนค่า -1 ถึง 1
            // frequency ทำให้การหมุนองศาเปลี่ยนแปลง
            // frame ทำให้เกิด animation
            // const n = random.noise2D(x + frame * 10, y, params.freq)
            const n = random.noise3D(x, y, f * 10, params.freq)
            const angle = n * Math.PI * params.amp // จะได้มุม -180 degrees ถึง 180 degrees
            ...
            context.save()
            // translate 3 ครั้งนี้เท่ากับเอามาบวกกันแล้ว translate ทีเดียว
